...
var OrderCancelledListener = /** @class */ (function (_super) {
  __extends(OrderCancelledListener, _super);
  function OrderCancelledListener() {
    var _this = (_super !== null && _super.apply(this, arguments)) || this;
    _this.subject = common_1.Subjects.OrderCancelled;
    _this.queueGroupName = queue_group_name_1.queueGroupName;
    return _this;
  }
  OrderCancelledListener.prototype.onMessage = function (data, msg) {
    return __awaiter(this, void 0, void 0, function () {
      var ticket, order;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, ticket_1.Ticket.findById(data.ticket.id)];
          case 1:
            ticket = _a.sent();
            if (!ticket) {
